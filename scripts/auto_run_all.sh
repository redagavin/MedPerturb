...
# Step 4: Run analysis (CPU)
echo "=== Running analysis ==="
python case_studies/baseline_analysis.py --results_dir results --output results/baseline_analysis.xlsx
python case_studies/sanity_check_analysis.py --results_dir results --output results/sanity_check_analysis.xlsx
python case_studies/precision_check_analysis.py --results_dir results --output results/precision_check_analysis.xlsx
